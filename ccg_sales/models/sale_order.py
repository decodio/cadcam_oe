...
class SaleOrderLine(models.Model):
    ...
    discount1_percent = fields.Float('Discount', digits=dp.get_precision('Discount Percent'))
    discount2_percent = fields.Float('Second discount', digits=dp.get_precision('Discount Percent'))
...
class SaleOrder(models.Model):
    _name = 'sale.order'
    _inherit = 'sale.order'
    global_discount_percent = fields.Float('Global discount', digits=dp.get_precision('Discount Percent'), readonly=False)
